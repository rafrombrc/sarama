...
// MockOffesetCommitResponse is a `OffsetCommitResponse` builder.
type MockOffesetCommitResponse struct {
	errors map[string]map[string]map[int32]KError
	t      *testing.T
}

func NewMockOffsetCommitResponse(t *testing.T) *MockOffesetCommitResponse {
	return &MockOffesetCommitResponse{t: t}
}

func (mr *MockOffesetCommitResponse) SetError(group, topic string, partition int32, kerror KError) *MockOffesetCommitResponse {
	if mr.errors == nil {
...
func (mr *MockOffesetCommitResponse) For(reqBody decoder) encoder {
...
func (mr *MockOffesetCommitResponse) getError(group, topic string, partition int32) KError {
	topics := mr.errors[group]
	if topics == nil {
		return ErrNoError
	}
